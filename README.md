# chopin-opus-38
[LilyPond](https://lilypond.org/) engraving source files used to create Chopin's Ballade, opus 38.
...
The PDF and MIDI files can be created by issuing the following command in the directory this file is in (assuming you have `lilypond` in your PATH variable):
        ...
        lilypond ballade-op38.ly

To create a smaller PDF, try:

        lilypond -dno-point-and-click ballade-op38.ly

You may also [download the latest release](https://github.com/ksnortum/chopin-opus-38/releases/latest) to get the compiled PDF and MIDI files.
