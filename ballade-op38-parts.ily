...
rightHandUpper = \relative {
  ...
  \magnifyMusic #2/3 { a8~[ c~ f_~]
    << 
      { \voiceFour <a, c f>2.*1/2) } 
      \new Voice { 
        \omit TupletBracket
  ...
  <g a cs e a>4.^\cresc <a d f a>4 <b f' g b>8 |
  ...
  \barNumberCheck 105
  ef4 df8) cf4( cf8 |
  cf4 bf8) ef4(^\stretto ef8 |
  ef4 df8) \oneVoice <g, bf cs g'>8.\(( <gs cs gs'>16 <a! cs a'!>8) |
  <as e' g! as>8.(^\piuMosso <b e g b>16 <c e g c!>8)  <cs e bf' cs>8.(
  ...
  \barNumberCheck 129
  \voiceOne bf'4 a8) d4(^\> d8\! |
  d4 c8) bf4( bf8 |
  bf4 a8) d4(^\stretto d8 |
  d4 c8) \oneVoice <fs, a c fs>8.\((^\piuMosso <g c g'!>16 <af c af'>8) |
  ...
  <ds g a ds>8-. <e g a e'>-. r r4 r8 | \break % TODO remove
  ...
  \oneVoice <b, gs'>16 < a a'>->) r <a b>8->[( <f f'>-> q16->] <a b>16 <f f'>
    <gs b> <e e'>) |
  r16 <a c>( <gs c> <g c> <fs c'> <f c'>  <f b> <e b'> <ds b'> <e b'> <f b>
    <e b'>) |
  <bf' ef>16( <g bf> <fs bf> <f bf> <e bf'> <ef bf'>  <ef a> <d a'> <cs a'>
    <d a'> <ef a> <d a'>) |
  <af' df>16^( <f af> <e af> <ef af> <d af'> <df af'>~ \voiceOne af'16 g8 g->
...
leftHandLower = \relative {
  ...
  \moveParenA \after 16 _\markup "(" <a a'>8( gs'16\< a b cs  d\> e f e d 
    \moveParenB \after 32. _\markup ")" bf\! |
  \moveParenA \after 16 _\markup "(" <a, a'>8 gs'16\< a b cs  d\> e f e d 
  ...
  ff,8-.) r16 cf'( ef af  cf af ef cf ef'8-.) |
  ...
  <e e'>8. <d d'>16 <cs cs'>8) \clef treble <cs' cs'> r \clef bass <g,! g'!>( |
...
dynamics = {
  ...
  s2. * 6 |
  s4. s8 s\> s16 s\! |
  s16\parenthesize\mf\> s\! s4\cresc s4. |
